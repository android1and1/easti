...
(function() {
  ...
  var Account, Daka, Nohm, Session, Store, TICKET_PREFIX, accountModel, app, complement_save, convert, credential, crypto, dakaModel, ensure, expireAsync, express, filter, formidable, fs, getAsync, hashise, hostname, http, initSession, matchDB, path, pgrep, promisify, qr_image, redis, ruler, server, setAsync, sha256, spawn, static_root, superpass, updateAuthSession,
    indexOf = [].indexOf;
