...
(function() {
  ...
  var Account, Daka, Nohm, Session, Store, accountModel, app, credential, crypto, dakaModel, express, filter, fs, hashise, http, initSession, matchDB, path, pgrep, qr_image, redis, server, spawn, static_root, superpass, updateAuthSession;
  ...
  updateAuthSession = function(req, role) {
    ...
    if (role === 'unknown') {
      ...
      return req.session.auth.role = role;
    } else {
