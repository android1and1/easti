...
(function() {
  ...
  var ACCOUNT_WILDCARD, Account, DAKA_WILDCARD, Daka, Nohm, STATIC_ROOT, Session, Store, TICKET_MEDIA_ROOT, TICKET_PREFIX, _retreves, accountModel, app, complement_save, convert, credential, crypto, dakaModel, delAsync, existsAsync, expireAsync, express, filter, formidable, fs, getAsync, hashise, hgetAsync, hgetallAsync, hostname, http, initSession, lrangeAsync, matchDB, path, pgrep, promisify, qr_image, redis, ruler, server, setAsync, sha256, spawn, superpass, updateAuthSession,
    indexOf = [].indexOf;
...
// make length=5 words
  ...
  app.get('/admin/newest-ticket', async function(req, res) {
    ...
    if (((ref = req.session) != null ? (ref1 = ref.auth) != null ? ref1.role : void 0 : void 0) !== 'admin') {
      ...
      records = (await _retreves(keypattern, (function(a, b) {
        return b.ticket_id - a.ticket_id;
      })));
...
//objs is an array,elements be made by one object
  ...
  _retreves = function(keyname, sortby) {
