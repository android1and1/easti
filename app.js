...
(function() {
  ...
  var Account, DaKa, Nohm, NohmModel, PROJECT_ROOT, Session, Store, app, express, http, path, pgrep, qr_image, redis, server, spawn, static_root;
