...
(function() {
  ...
  var Account, Daka, Nohm, Session, Store, accountModel, app, complement_save, convert, credential, crypto, dakaModel, expireAsync, express, filter, formidable, fs, getAsync, hashise, http, initSession, matchDB, path, pgrep, promisify, qr_image, redis, ruler, server, setAsync, sha256, spawn, static_root, superpass, updateAuthSession,
    indexOf = [].indexOf;
