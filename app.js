...
(function() {
  ...
  var ACCOUNT_WILDCARD, Account, DAKA_WILDCARD, Daka, Nohm, STATIC_ROOT, Session, Store, TICKET_MEDIA_ROOT, TICKET_PREFIX, accountModel, app, complement_save, convert, credential, crypto, dakaModel, delAsync, ensure, existsAsync, expireAsync, express, filter, formidable, fs, getAsync, hashise, hgetAsync, hgetallAsync, hostname, http, initSession, lrangeAsync, matchDB, path, pgrep, promisify, qr_image, redis, ruler, server, setAsync, sha256, spawn, superpass, updateAuthSession,
    indexOf = [].indexOf;
...
// make length=5 words
  ...
  app.post('/admin/create-new-comment', function(req, res) {
    var agent, comment, comment_str, keyname, title;
